...
class ColourChooser(tk.Toplevel):
    ...
    def __init__(self, master, **kwargs):
        ...
        window_foreground_frame = tk.Frame(
            window_frame, bg=self.master.background
        )
        window_background_frame = tk.Frame(
            window_frame, bg=self.master.background
        )
        ...
        self.all_frames = [
            window_frame, window_foreground_frame, window_background_frame,
            text_frame, text_foreground_frame, text_background_frame
        ]

        window_label = ttk.Label(
            window_frame, text="Window:", anchor=tk.W, style="editor.TLabel"
        )
        foreground_label = ttk.Label(
            window_foreground_frame,
            text="Foreground:",
            anchor=tk.E,
            style="editor.TLabel"
        )
        background_label = ttk.Label(
            window_background_frame,
            text="Background:",
            anchor=tk.E,
            style="editor.TLabel"
        )
        ...
        text_label = ttk.Label(
            text_frame, text="Editor:", anchor=tk.W, style="editor.TLabel"
        )
        text_foreground_label = ttk.Label(
            text_foreground_frame,
            text="Foreground:",
            anchor=tk.E,
            style="editor.TLabel"
        )
        text_background_label = ttk.Label(
        ...
        foreground_colour_chooser = ttk.Button(
            window_foreground_frame,
            text="Change Foreground Colour",
            width=26,
            style="editor.TButton",
            command=lambda sv=self.chosen_foreground_colour: self.
            set_colour(sv)
        )
        background_colour_chooser = ttk.Button(
            window_background_frame,
            text="Change Background Colour",
            width=26,
            style="editor.TButton",
            command=lambda sv=self.chosen_background_colour: self.
            set_colour(sv)
        )
        text_foreground_colour_chooser = ttk.Button(
            text_foreground_frame,
            text="Change Text Foreground Colour",
            width=26,
            style="editor.TButton",
            command=lambda sv=self.chosen_text_foreground_colour: self.
            set_colour(sv)
        )
        text_background_colour_chooser = ttk.Button(
            text_background_frame,
            text="Change Text Background Colour",
            width=26,
            style="editor.TButton",
            command=lambda sv=self.chosen_text_background_colour: self.
            set_colour(sv)
        )

        foreground_colour_preview = ttk.Label(
            window_foreground_frame,
            textvar=self.chosen_foreground_colour,
            style="editor.TLabel"
        )
        background_colour_preview = ttk.Label(
            window_background_frame,
            textvar=self.chosen_background_colour,
            style="editor.TLabel"
        )
        text_foreground_colour_preview = ttk.Label(
            text_foreground_frame,
            textvar=self.chosen_text_foreground_colour,
            style="editor.TLabel"
        )
        text_background_colour_preview = ttk.Label(
            text_background_frame,
            textvar=self.chosen_text_background_colour,
            style="editor.TLabel"
        )
        ...
        foreground_colour_preview.pack(
            side=tk.LEFT, expand=1, fill=tk.X, padx=(15, 0)
        )

        background_label.pack(side=tk.LEFT, fill=tk.X, padx=(30, 27))
        background_colour_chooser.pack(side=tk.LEFT)
        background_colour_preview.pack(
            side=tk.LEFT, expand=1, fill=tk.X, padx=(15, 0)
        )
        ...
        text_foreground_colour_preview.pack(
            side=tk.LEFT, expand=1, fill=tk.X, padx=(15, 0)
        )

        text_background_label.pack(side=tk.LEFT, fill=tk.X, padx=(30, 27))
        text_background_colour_chooser.pack(side=tk.LEFT)
        text_background_colour_preview.pack(
            side=tk.LEFT, expand=1, fill=tk.X, padx=(15, 0)
        )

        save_button = ttk.Button(
            self, text="save", command=self.save, style="editor.TButton"
        )
    ...
    def save(self):
        ...
        yaml_file_contents = (
            ...
            "text_background: '{}'\n".format(
                self.chosen_text_background_colour.get()
            ) + "text_foreground: '{}'\n".format(
                self.chosen_text_foreground_colour.get()
            )
        )
        ...
        self.master.apply_colour_scheme(
            self.chosen_foreground_colour.get(),
            self.chosen_background_colour.get(),
            self.chosen_text_foreground_colour.get(),
            self.chosen_text_background_colour.get()
        )
